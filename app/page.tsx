          ...
          <section className='text-black body-font'>
            <div className='container mx-auto flex px-5 py-24 md:flex-row flex-col items-center'>
              <div className='lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center bg-white bg-opacity-50 p-8 '>
                ...
                {title || 'Discovering New Avenues of Creative Expression: A Relaxed and Open-Minded Journey'}
                </h1>
                <p className='mb-8 leading-relaxed'>{description || 'Play Guess the Drawing, an exciting AI-powered game that invites you to test your drawing skills! Relax and have fun while competing against cutting-edge technology in a friendly atmosphere. See if you can stump our AI'}</p>
